...
def _make_sample_benchmark() -> list[dict]:
    ...
    return [
        {
            "id": "BM-0000",
            "text": "test text about arrest",
            "expected_fraud_type": "digital_arrest",
        ...
        {
            "id": "BM-0001",
            "text": "test text about investment",
            "expected_fraud_type": "investment_fraud",
            "expected_risk": "danger",
            "district": "delhi",
            "language": "en",
        },
        {
            "id": "BM-0002",
            "text": "test text about job",
            "expected_fraud_type": "job_fraud",
...
class TestComputeMetrics:
    def test_perfect_predictions(self) -> None:
        results = [
            PredictionResult(
                "1", "digital_arrest", "digital_arrest", "danger", "danger", 0.9, False, True, True
            ),
            PredictionResult(
                "2",
                "investment_fraud",
            ...
            PredictionResult(
                "3", "job_fraud", "job_fraud", "suspicious", "suspicious", 0.75, False, True, True
            ),
        ]
    ...
    def test_mixed_results(self) -> None:
        results = [
            ...
            PredictionResult(
                "4", "job_fraud", "job_fraud", "suspicious", "suspicious", 0.8, False, True, True
            ),
        ]
        summary = compute_metrics(results)
    ...
    def test_computes_per_type_metrics(self) -> None:
        results = [
            ...
            PredictionResult(
                "2", "digital_arrest", "digital_arrest", "danger", "danger", 0.8, False, True, True
            ),
            PredictionResult(
                "3",
                "digital_arrest",
